...
_SERVICE_NAME = "workgate-worker"
_LAUNCHD_LABEL = "top.rijuyuezhu.workgate.worker"
_WORKER_MANAGED_ENV = "WORKGATE_WORKER_MANAGED"
_WORKER_LOCK_INHERIT_ENV = "WORKGATE_WORKER_LOCK_HANDLE"
