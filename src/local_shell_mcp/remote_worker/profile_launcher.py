...
os.environ["LOCAL_SHELL_MCP_WORKER_STATE_DIR"] = str(state_dir)
os.environ["LOCAL_SHELL_MCP_WORKER_PROFILE_ID"] = profile_id
os.environ["LOCAL_SHELL_MCP_WORKER_RUNTIME_SHA256"] = digest
