...
class Settings(BaseSettings):
    ...
    """Dynamic OAuth client registration lifetime in seconds. Registrations are persisted in the state directory; set to 0 to disable time-based expiration."""
    oauth_max_dynamic_clients: int = 256
    """Maximum persisted dynamic OAuth clients. Set to 0 to disable this capacity limit."""
