...
| `environment_info` | `version`, plus session-bound inspection through `bash` | The standalone tool is intentionally absent. Stable structured environment orientation will be added to `session_start` and related session responses instead. |
